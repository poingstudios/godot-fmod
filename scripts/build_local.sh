...
show_help() {
    ...
    echo "  ./scripts/build_local.sh macos template_debug arm64"
    echo "  ./scripts/build_local.sh windows template_release x86_64"
}
...
echo ">>> Building Godot FMOD ($PLATFORM, $TARGET, $ARCH) with $NPROC jobs..."
